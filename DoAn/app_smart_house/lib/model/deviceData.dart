...
<<<<<<< HEAD
  ...
  Device({required this.id,required this.name,required this.effect,required this.room,required this.status,required this.type,required this.mode,required this.data,required this.id_room}); 
