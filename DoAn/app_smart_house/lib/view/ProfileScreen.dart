...
class _UserInfoItemState extends State<UserInfoItem> {
  ...
  void _modalBottomSheetMenu(int stt, User2 user) {
    ...
    showModalBottomSheet(
        context: context,
        builder: (context) {
          Sex? _sex = user.sex==""?Sex.unknow:(user.sex=="Nam"?Sex.male:Sex.female);
      ...
      const Padding(padding: EdgeInsets.only(top: 10)),
        ...
        children: [
          ...
          GestureDetector(
            ...
            child: Row(children: [
              Text(
                widget.user.account.length>18?widget.user.account.substring(0,18)+"...":widget.user.account,
                style: const TextStyle(fontSize: 15),
              ),
              const Icon(Icons.edit_square)
            ]
      ...
      const Padding(padding: EdgeInsets.only(top: 10)),
        ...
        children: [
          ...
          GestureDetector(
            ...
            child: Row(children: [
              Text(
                widget.user.email.length>18?widget.user.email.substring(0,18)+"...":widget.user.email,
                style: const TextStyle(fontSize: 15),
              ),
              const Icon(Icons.edit_square)
            ]
